...
Societal Innovation Team`,
      html: `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:auto">
          ...
          <div style="font-size:32px;font-weight:bold;letter-spacing:8px;padding:20px;text-align:center;background:#f3f4f6;border-radius:10px">${otp}</div>
          <p>This OTP will expire in <strong>10 minutes</strong>.</p>
          <p>If you did not request this ${
            purpose === "PASSWORD_RESET" ? "password reset" : "verification"
          }, please ignore this email.</p>
          <p>Regards,<br/>Societal Innovation Team</p>
        </div>
      `,
    });
  } catch (error) {
